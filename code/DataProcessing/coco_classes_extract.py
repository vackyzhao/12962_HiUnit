...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', "--src", dest="src_root", default="D:/dataset/coco/coco_yolo/coco_yolo/",
                        help="source root dir of coco_yolo labels and images")
    parser.add_argument('-d', "--dst", dest="dst_root", default="./coco_yolo_cat/",
                        help="destination root dir")
    parser.add_argument('-c', "--classes", dest="dst_classes", default=['15'], nargs='+',
